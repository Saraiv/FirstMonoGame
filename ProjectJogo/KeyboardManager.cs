...
namespace ProjectJogo
{
    class KeyboardManager
    {
        ...
        bool IsKeyPressed(Keys k) => keyAndState.ContainsKey(k) && keyAndState[k] == KeyState.PRESSED;
        bool IsKeyUp(Keys k) => keyAndState.ContainsKey(k) && keyAndState[k] == KeyState.UP;
        bool IsKeyHeld(Keys k) => keyAndState.ContainsKey(k) && keyAndState[k] == KeyState.HELD;
    }
}
